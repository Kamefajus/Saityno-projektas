...
public record MovieDto(int Id, string Title, string Description, DateTimeOffset CreatedAt);

public record CreateOrUpdateMovieDto(string Title, string Description )
{
    public class CreateOrUpdateMovieDtoValidator : AbstractValidator<CreateOrUpdateMovieDto>
    {
        public CreateOrUpdateMovieDtoValidator()
        {
...
{
        new(linkGenerator.GetUriByName(httpContext, "GetMovies"), "movies", "GET"),
        new(linkGenerator.GetUriByName(httpContext, "CreateMovie"), "createMovie", "POST"),
